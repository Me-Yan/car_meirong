...
<%
    try {
        ...
        String ruku=encoding.toString(request.getParameter("ruku"));
        ...
        // 添加信息的SQL语句
        String sql = "insert into guocheng(k_name,c_name,ruku,feiyong,beizhu,shijian) values('"+k_name+"','"+c_name+"','"+ ruku + "','" +feiyong+"','"+beizhu+"','"+ times.showTodayTime()+"')";
