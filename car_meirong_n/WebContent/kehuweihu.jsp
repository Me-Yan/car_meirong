        ...
        <td width="100%" valign="top">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td width="150" align="center" bgcolor="#999999">¿Í»§¸ºÔðÈË</td>
                    ...
                    <td width="80" align="center" bgcolor="#999999">²Ù×÷</td>
                </tr>
                <%
                    int CountPage1 = 0;
                    int CurrPage1 = 1;
                ...
                <tr>
                    ...
                    <td align="center"><a class="btn" style="width: 70px;" href="genjin.jsp?id=<%=rs.getString("id")%>">¿Í»§¸ú½ø</a></td>
                </tr>
                <%
                                    rs.next();
                                    i++;
