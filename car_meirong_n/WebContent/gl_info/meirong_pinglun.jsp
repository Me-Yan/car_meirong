        ...
        <td width="100%" valign="top">
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td width="450" align="center" bgcolor="#999999">ÆÀÂÛÄÚÈÝ</td>
                    <td width="38" align="center" bgcolor="#999999">²Ù×÷</td>
                </tr>
                <%
                    int CountPage1 = 0;
                    int CurrPage1 = 1;
                ...
                <tr>
                    ...
                    <td align="center"><a class="btn" href="del.jsp?id=<%=rs.getString("id")%>&tt=5">É¾³ý</a></td>
                </tr>
                <%
                                    rs.next();
                                    i++;
