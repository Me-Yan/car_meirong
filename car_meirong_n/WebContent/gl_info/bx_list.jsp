...
<body>
<table class="outer">
    <tr><td><a class="btn" href="bx_add.jsp" style="padding: 5px 10px;">ÐÂÔö±£ÏÕ</a></td></tr>
    <tr>
        <td height="495px" valign="top">
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td width="203" height="30" align="center" bgcolor="#999999">±£ÏÕÃû³Æ</td>
                    <td width="500" align="center" bgcolor="#999999">±£ÏÕÄÚÈÝ</td>
                ...
                <tr>
                    ...
                    <td align="center"><a class="btn" href="del.jsp?id=<%=rs.getString("id")%>&tt=12">É¾³ý</a></td>
                </tr>
                <%
                                    rs.next();
                                    i++;
