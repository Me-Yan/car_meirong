...
<body>
<table class="outer">
    <tr><td><a class="btn" href="k_add.jsp" style="padding: 5px 10px;">ÐÂÔö¿Í»§</a></td></tr>
    <tr>
        <td height="495px;" valign="top">
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    <td width="134" height="30" align="center" bgcolor="#999999">¿Í»§Ãû³Æ</td>
                    <td width="168" align="center" bgcolor="#999999">¿Í»§¸ºÔðÈË</td>
                    <td width="134" align="center" bgcolor="#999999">ÁªÏµ·½Ê½</td>
                    <td width="107" align="center" bgcolor="#999999">ÊÇ·ñ»áÔ±</td>
                    <td width="125" align="center" bgcolor="#999999">Ê±¼ä</td>
                ...
                <tr>
                    ...
                    <td align="center">
                        <a class="btn" href="k_up.jsp?id=<%=rs.getString("id")%>">ÐÞ¸Ä</a>
                        <a class="btn" href="del.jsp?id=<%=rs.getString("id")%>&tt=2">É¾³ý</a>
                    </td>
                        <%
	            				rs.next();
	            				i++;
            ...
            <table width="702" height="71" border="0" cellpadding="0" cellspacing="0">
                <tr >
                    <td width="511" colspan="2"><p>[<%=CurrPage1%>/<%=CountPage1 %>] Ã¿Ò³<%=PageSize1%>Ìõ ¹²<%=CountRow%>Ìõ¼ÇÂ¼
                        ...
                        <a href="k_gl.jsp?Page=<%=i%>"><font color="#FF0000">[<%=i%>]</font></a>
                            <%}%>
                    </td>
                </tr>
            </table>
