...
<body>
<table class="outer">
    <tr><td><a class="btn" href="car_add.jsp" style="padding: 5px 10px;">ÐÂÔöÆû³µ</a></td></tr>
    <tr>
        <td height="495px" valign="top">
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td width="150" align="center" bgcolor="#999999">²Ù×÷</td>
                </tr>
                <%
                    int CountPage1 = 0;
                    int CurrPage1 = 1;
                ...
                <tr>
                    ...
                    <td align="center">
                        <a class="btn" href="del.jsp?id=<%=rs.getString("id")%>&tt=13">É¾³ý</a>
                        <a class="btn" href="car_update.jsp?id=<%=rs.getString("id")%>">ÐÞ¸Ä</a>
                    </td>
                </tr>
                <%
                                    rs.next();
