        ...
        <td width="100%" valign="top">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td width="128" align="center" bgcolor="#999999">³äÖµ½ð¶î</td>
                    <td width="180" align="center" bgcolor="#999999">³äÖµÊ±¼ä</td>
                ...
                <%
                    ...
                    if (conp != null)
                    {
                        try
                        {
                            ...
                            String sql = "Select * from chongzhi ";
                ...
                <tr>
                    ...
                    <td align="center"><a class="btn" href="gl_info/del.jsp?id=<%=rs.getString("id")%>&tt=7">É¾³ý</a></td>
                </tr>
                <%
                                    rs.next();
                                    i++;
            ...
            <table width="702" height="71" border="0" cellpadding="0" cellspacing="0">
                <tr >
                    <td width="511" colspan="2"><p>[<%=CurrPage1%>/<%=CountPage1 %>] Ã¿Ò³<%=PageSize1%>Ìõ ¹²<%=CountRow%>Ìõ¼ÇÂ¼
                        ...
                        <a href="huiyuankachongzhi.jsp?Page=<%=i%>"><font color="#FF0000">[<%=i%>]</font></a>
                            <%}%>
                    </td>
                </tr>
            </table></td>
