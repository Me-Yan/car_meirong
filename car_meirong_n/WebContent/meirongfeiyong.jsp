        ...
        <td width="100%" valign="top">
            ...
            <table width="100%" border="0" cellpadding="0" cellspacing="0">
                <tr>
                    ...
                    <td width="133" align="center" bgcolor="#999999">²úÆ·Ãû³Æ</td>
                    <td width="109" align="center" bgcolor="#999999">ËùÐè·ÑÓÃ</td>
                    <td width="80" align="center" bgcolor="#999999">·ÑÓÃ×´Ì¬</td>
                    <td width="80" align="center" bgcolor="#999999">½áËã·ÑÓÃ</td>
                </tr>
                <%
                    int CountPage1 = 0;
                    int CurrPage1 = 1;
                ...
                <tr>
                    ...
                    <td align="center"><a style="width: 70px" class="btn" href="jiesuan.jsp?id=<%=rs.getString("id")%>&&feiyong=<%=rs.getString("feiyong")%>&&k_name=<%=rs.getString("k_name")%>">½áËã·ÑÓÃ</a></td>
                </tr>
                <%
                                    rs.next();
                                    i++;
